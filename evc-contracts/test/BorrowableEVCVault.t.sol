...
import "../src/BorrowableEVCVault.sol";

contract TestVault is BorrowableEVCVault {
    ...
    ) BorrowableEVCVault(_evc, _asset, _name, _symbol) {}
...
contract VaultTest is ERC4626Test {
    ...
    function setUp() public override {
        ...
        _vault_ = address(new TestVault(_evc_, IERC20(_underlying_), "Vault", "VLT"));
    }
    ...
    function test_DepositWithEVC(address alice, uint64 amount) public {
        ...
        BorrowableEVCVault vault = BorrowableEVCVault(_vault_);
    ...
    function test_assignment_BasicFlow(address alice, address bob, address charlie, uint64 amount) public {
        ...
        _evc_.call(
            ...
            alice,
            0,
            abi.encodeWithSelector(BorrowableEVCVault.repay.selector, amountToBorrow - amountToBorrow / 2, alice)
        );
