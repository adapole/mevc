...
contract BridgeServiceManager is ECDSAServiceManagerBase, Vault {
    ...
    /// @dev Double attestations would technically be valid and allow operators to recursively call until funds are
    /// released
     ...
     * @param _avsDirectory The address of the AVS directory contract, managing AVS-related data for registered
     * operators
     ...
     * @param _delegationManager The address of the delegation manager contract, managing staker delegations to
     * operators
     * @param _crankGasCost The estimated gas cost for calling release funds, used to calculate rebate and incentivize
     * users to call
    ...
    function challengeAttestation(
        ...
        require(
            ...
            "Operator has not attested to this bridge request"
        );
